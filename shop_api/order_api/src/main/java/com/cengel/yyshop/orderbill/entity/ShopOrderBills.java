...
@Getter
@Setter
@Entity(name = "SHOP_ORDER_BILLS")
public class ShopOrderBills extends BaseEntity<Integer> {
	...
	// 
	@Column(name="IS_LOAD_BILL")
	private   String  isLoadBill;
	// 
	@Column(name="USER_ID")
	...
	// 
	@Column(name="IS_USE_INTEGRAL")
	private   String  isUseIntegral;
	// 
	@Column(name="PARENT_AMOUNT")
	private   java.math.BigDecimal  parentAmount;
	// 
	...
	// 
	@Column(name="SUB_SHIPPING_FEE")
	private   java.math.BigDecimal  subShippingFee;
	// 
	@Column(name="AUTOCONFIRMRECEIPTTIME")
